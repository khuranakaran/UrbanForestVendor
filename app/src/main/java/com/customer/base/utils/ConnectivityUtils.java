...
public class ConnectivityUtils {
    ...
    public static void logNetworkState(Context pContext) {
        ...
        if (activeNetwork == null) {
            LoggerUtil.i(LOG_TAG, "No any active network found.");
            return;
        }
        LoggerUtil.i(LOG_TAG, "Active Network. Type: " + activeNetwork.getTypeName());
        LoggerUtil.i(LOG_TAG, "Active Network. isConnected: " + activeNetwork.isConnected());
        LoggerUtil.i(LOG_TAG, "Active Network. isConnectedOrConnecting: " + activeNetwork.isConnectedOrConnecting());
        LoggerUtil.i(LOG_TAG, "Active Network. N/W State Reason: " + activeNetwork.getReason());
    }
